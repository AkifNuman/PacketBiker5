...
enum class SimulateLocation :uint8
{
	...
	IN_EEA = 1 UMETA(DisplayName = "IN_EEA"),

	NOT_IN_EEA = 2 UMETA(DisplayName = "NOT_IN_EEA"),
};
...
public:
	...
	UPROPERTY(Config, EditAnywhere, Category = Android, Meta = (DisplayName = "Disable AdColony"))
	bool DisableAndroidAdColony;

	UPROPERTY(Config, EditAnywhere, Category = Android, Meta = (DisplayName = "Disable IronSource"))
	bool DisableAndroidIronSource;

	UPROPERTY(Config, EditAnywhere, Category = Android, Meta = (DisplayName = "Disable InMobi"))
	bool DisableAndroidInMobi;

	UPROPERTY(Config, EditAnywhere, Category = Android, Meta = (DisplayName = "Disable TapJoy"))
	bool DisableAndroidTapJoy;

	UPROPERTY(Config, EditAnywhere, Category = Android, Meta = (DisplayName = "Disable I-Mobile"))
	bool DisableAndroidIMobile;

	UPROPERTY(Config, EditAnywhere, Category = Android, Meta = (DisplayName = "SimulateAndroidLocation"))
	SimulateLocation SimulateAndroidLocation;
    ...
    UPROPERTY(Config, EditAnywhere, Category = IOS, Meta = (DisplayName = "SimulateIOSLocation"))
    SimulateLocation SimulateIOSLocation;

	UPROPERTY(Config, EditAnywhere, Category = IOS, Meta = (DisplayName = "Disable Unity"))
		bool DisableIOSUnity;

	UPROPERTY(Config, EditAnywhere, Category = IOS, Meta = (DisplayName = "Disable Vungle"))
		bool DisableIOSVungle;

	UPROPERTY(Config, EditAnywhere, Category = IOS, Meta = (DisplayName = "Disable Chartboost"))
		bool DisableIOSChartboost;

	UPROPERTY(Config, EditAnywhere, Category = IOS, Meta = (DisplayName = "Disable Facebook"))
		bool DisableIOSFacebook;

	UPROPERTY(Config, EditAnywhere, Category = IOS, Meta = (DisplayName = "Disable Applovin"))
		bool DisableIOSApplovin;

	UPROPERTY(Config, EditAnywhere, Category = IOS, Meta = (DisplayName = "Disable AdColony"))
		bool DisableIOSAdColony;

	UPROPERTY(Config, EditAnywhere, Category = IOS, Meta = (DisplayName = "Disable IronSource"))
		bool DisableIOSIronSource;

	UPROPERTY(Config, EditAnywhere, Category = IOS, Meta = (DisplayName = "Disable InMobi"))
		bool DisableIOSInMobi;

	UPROPERTY(Config, EditAnywhere, Category = IOS, Meta = (DisplayName = "Disable TapJoy"))
		bool DisableIOSTapJoy;

	UPROPERTY(Config, EditAnywhere, Category = IOS, Meta = (DisplayName = "Disable I-Mobile"))
		bool DisableIOSIMobile;
