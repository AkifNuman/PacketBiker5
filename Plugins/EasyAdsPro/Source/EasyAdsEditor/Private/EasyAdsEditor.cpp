...
void FEasyAdsEditorModule::StartupModule()
{
	...
	FString GameActivityTemplatePath = EnginePath / TEXT("Build/Android/Java/src/com/epicgames/unreal/GameActivity.java.template");
	...
	if (FFileHelper::LoadFileToString(Result, *GameActivityTemplatePath) )
	{
		...
		Result = Result.Replace(TEXT("android.support.v4.app"), TEXT("androidx.core.app"));
